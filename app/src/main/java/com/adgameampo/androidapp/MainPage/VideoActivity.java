...
import com.adgameampo.androidapp.ProfileActivity;
...
//                }
        ...
        PlayeVideoImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final MediaPlayer mp = MediaPlayer.create(VideoActivity.this, R.raw.video_sound);
                try {
                    mp.start();
                }
                catch (Exception e)
                                            ...
                                            public void onFailure(Call call, IOException e) {
                                                ...
                                                runOnUiThread(new Runnable() {
                                                    public void run() {
                                                        ...
                                                        Toast.makeText(VideoActivity.this, "دوباره بزن تا برنده شی\n تا ۱۸:۱۸ وقت داری.", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
                                            @Override
