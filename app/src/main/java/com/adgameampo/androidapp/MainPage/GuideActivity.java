...
public class GuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = "(البته خلاصش اینه که حتما هر روز ساعت ۱۸ تا ۱۸:۱۸ به آد سر بزنید ولی بقیش رو حتما بخونید)\n" +
                "\n" +
                "برنده شدن توی آد خیلی راحته ، هر کی در آخر هفته امتیازش بیشتر باشه برنده میشه\n" +
                "برای جمع کردن امتیاز فقط کافیه که ویدیو ببینید ،هر ویدیو ۱۰۰ امتیاز داره و برای اینکه خیلی سخت نباشه فقط روزی ۱۸ دقیقه ویدیو پخش میکنیم اون هم در ساعت ۱۸ تا ۱۸:۱۸\n" +
                "هر کی زودتر این ویدیوها رو ببینه امتیازش رو میگیره ولی اگه نتونستید همه ویدیوها رو ببینید اصلا نگران نباشید \n" +
                "چون هر روز یه ویدیو شگفت انگیز داریم که امتیازش از بقیه خیلی بالاتره ولی ساعت نمایشش رو شما باید تشخیص بدید، ولی چجوری؟؟\n" +
                "بین اون ویدیوهای ساعت ۱۸ تا ۱۸:۱۸ یه ویدیو سوالی هست که همه اونو میبینن که جواب سوال ، ساعتی است که ویدیو شگفت انگیز پخش میشه \n" +
...
//        final Animation SlideOpenButtonMoney= AnimationUtils.loadAnimation(this,R.anim.slide_open_button_money);
        ...
        SMSNumberButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    final Animation Click = AnimationUtils.loadAnimation(GuideActivity.this,R.anim.click);
